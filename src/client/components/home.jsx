...
import { createUrl, updateHash, updateUser } from "../actions/docs";
...
class Home extends React.Component {
  ...
  shortenUrl() {
    ...
    if (url.substr(0, HTTP_STRING_SIZE) !== "http") {
      url = `http://${url}`;
    }
  ...
  render() {
    ...
    const theme = (this.props.theme === "dark") ? darkBaseTheme : "";
...
Home.propTypes = {
  ...
  updateHash: React.PropTypes.func,
