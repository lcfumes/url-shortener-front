...
class ListUrls extends React.Component {
  ...
  _refreshButton() {
    if (this.state.loading === false)
      return <FontIcon className="material-icons" onClick={(e) => this.props.updateDocs()}>refresh</FontIcon>;
...
export default connect(mapStateToProps, mapDispatchToProps)(ListUrls);